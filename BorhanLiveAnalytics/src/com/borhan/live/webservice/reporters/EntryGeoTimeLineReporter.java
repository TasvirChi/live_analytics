...
import com.borhan.ip2location.Coordinate;
...
import com.borhan.live.webservice.model.GeoTimeLiveStats;
import com.borhan.live.webservice.model.LiveReportInputFilter;
import com.borhan.live.webservice.model.LiveReportOrderBy;
...
public class EntryGeoTimeLineReporter extends BaseReporter {
	...
	private String generateQuery(LiveReportInputFilter filter, boolean count) {
		...
		sb.append(" from borhan_live.live_events_location where ");
