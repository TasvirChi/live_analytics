...
public class SessionsCache {
	...
	public static Session getSession(String node) throws BorhanInternalException {
	...
	private static void connect(String node) throws BorhanInternalException {
		try {
	     ...
	     // TODO - Discuss with Orly the possibility to connect to a given key-space cluster.connect(key-space)
			...
			throw new BorhanInternalException("Failed to connect to host [" + node + "]", ex);
		}
	}
